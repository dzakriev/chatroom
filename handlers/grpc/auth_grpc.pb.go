...
const (
	AuthService_Auth_FullMethodName = "/grpc.AuthService/Auth"
)
...
func (c *authServiceClient) Auth(ctx context.Context, in *AuthRequest, opts ...grpc.CallOption) (*AuthResult, error) {
...
func (UnimplementedAuthServiceServer) Auth(context.Context, *AuthRequest) (*AuthResult, error) {
